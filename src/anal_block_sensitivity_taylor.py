...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', type=str, default="output_block_sensitivity/llama-1-7b/taylor_n10")
            ...
            for k, param in model.named_parameters():
                if param.requires_grad and 'weight' in k and 'embed_tokens' not in k:                    
                    ...
                    if 'proj' in k or 'lm_head' in k: # output_dim x input_dim
                        weight_imp=salience_dict[k].abs().pow(norm_power).sum(1) # [output_dim]
