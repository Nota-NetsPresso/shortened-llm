...
export OUTPUT_SENSITIVITY=output_block_sensitivity/$MODEL_NAME/magnitude_n${NUM_CALIB_DATA}
export OUTPUT_PRUNE=output_prune/$MODEL_NAME/magnitude_n${NUM_CALIB_DATA}/rm_${NUM_PRUNED_BLOCKS}_blocks
export OUTPUT_TUNE=output_tune/$MODEL_NAME/magnitude_n${NUM_CALIB_DATA}/rm_${NUM_PRUNED_BLOCKS}_blocks

# Analyze the magnitude-based block importance with 10 calibration samples
python src/anal_block_sensitivity_magnitude.py \
